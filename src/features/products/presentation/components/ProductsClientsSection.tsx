...
interface ProductsClientsSectionProps {
  clients: ClientItemEntity[];
}

export function ProductsClientsSection({ clients }: ProductsClientsSectionProps) {
    ...
    <section className="py-20 lg:py-24 bg-muted/20 border-b border-border overflow-hidden">
      <Container className="space-y-10 text-center">
        ...
        <div className="relative w-full overflow-hidden mask-gradient group/marquee">
          <div className="pointer-events-none absolute inset-y-0 start-0 w-16 sm:w-24 bg-gradient-to-r from-background to-transparent z-10" />
          <div className="pointer-events-none absolute inset-y-0 end-0 w-16 sm:w-24 bg-gradient-to-l from-background to-transparent z-10" />
