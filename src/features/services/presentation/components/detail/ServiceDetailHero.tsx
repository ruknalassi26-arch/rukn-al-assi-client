      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative aspect-4/3 sm:aspect-5/4 lg:aspect-4/3 w-full rounded-3xl overflow-hidden bg-muted shadow-2xl border border-border border-s-6 border-s-primary group">
              <Image
                src={displayImage}
                alt={service.name}
                fill
