...
export function ServicesCtaSection() {
  ...
  return (
    <section className="relative py-24 lg:py-32 bg-slate-950 text-white overflow-hidden border-t border-white/10">
      ...
      <Container className="relative z-10 text-center max-w-3xl space-y-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
          ...
          >
            <Link href={`/${locale}/rfq`} className="flex items-center gap-2.5">
