...
import { ProjectClientEntity } from "../../domain/entities/project.entity";

interface ProjectsClientsSectionProps {
  clients: ProjectClientEntity[];
}

export function ProjectsClientsSection({ clients }: ProjectsClientsSectionProps) {
